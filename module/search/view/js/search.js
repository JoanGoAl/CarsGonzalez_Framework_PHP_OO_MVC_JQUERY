function load_search() {
    ...
    url = friendlyURL("?page=search&op=list_info_search")
    ...
    $(inputText).on('keyup', function() {
        ...
        if (inputText.value != '') {
            ...
            url = friendlyURL("?page=search&op=autocomplete")
            ajaxPromise("POST", url, "json", {city : inputText.value})
                .then(function(info) {
    ...
    serachImg.src = 'view/img/search-icon.png'
